...
| File | Description |
|------|-------------|
| `inputs/asv_table.csv` | 16S ASV count table (997 ASVs × 29 samples) |
| `inputs/taxonomy.csv` | ASV taxonomy (Kingdom → Species) |
| `inputs/metadata.csv` | Patient metadata (PatientID, Treatment, SALT_score, Timepoint, antibiotics) |
| `inputs/metacyc_pathway_table.csv` | MetaCyc pathway RPK abundance (942 PWYs × 29 samples) |
| `inputs/ec_pathway_table.csv` | EC number RPK abundance (2315 ECs × 29 samples) |
